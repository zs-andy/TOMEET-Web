  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-50">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-2 text-sm text-gray-500 text-center">{t("loginSubtitle")}</p>
        ...
        <div className="mt-8 space-y-4">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-orange-500 text-white font-medium rounded-full hover:bg-orange-600 transition-colors text-sm cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
            >
